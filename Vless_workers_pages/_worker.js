...
let userID = "ff9512ed-f2f4-4836-9659-25fd160c710c";

const proxyIPs = ["proxyip.sg.fxxk.dedyn.io"]; //ts.hpc.tw workers.cloudflare.cyou bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org
const cn_hostnames = [''];
